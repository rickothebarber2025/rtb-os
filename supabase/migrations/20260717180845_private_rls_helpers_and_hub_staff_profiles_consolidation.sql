...
-- ============================================================
-- 1. Move the 3 internal RLS helper functions to the private
--    schema (matches existing convention: private.can_access_*)
--    so they stop being callable as public RPC endpoints, while
--    remaining fully usable inside RLS policies.
-- ============================================================
...
-- ============================================================
-- 3. hub_staff_profiles: merge the two overlapping SELECT
--    policies into one (fixes "multiple permissive policies"),
--    and stop re-checking auth.uid() per row by wrapping it in
--    a scalar subquery (fixes "auth_rls_initplan"). Both the
--    canonical hub_staff_profiles-based business match AND the
--    legacy user_profiles-based fallback are preserved.
-- ============================================================
...
-- ============================================================
-- 4. Retire the old public-schema functions now that nothing
--    references them.
-- ============================================================
