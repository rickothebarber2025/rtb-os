...
--
-- Verified via a rolled-back transaction against a real auth id: a
-- bare pending row for Roshi's roster email came out with role=staff,
-- active=true, business_unit_id=RTB Lounge, staff_hub=view. No live
-- data was changed by the test.
