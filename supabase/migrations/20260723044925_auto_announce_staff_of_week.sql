...
-- Extend lock_payroll_run to call the announcement after the
-- existing performance-history sync, wrapped so any failure here is
-- swallowed (belt and suspenders on top of the function's own
