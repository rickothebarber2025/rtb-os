...
export const ROLE_TEMPLATES = [
  ...
  {
    description: 'Runs RTB Beauty Lounge daily operations. Financial and system access stay off unless the owner explicitly adds them.',
    expectations: 'Keep RTB Beauty Lounge appointment, roster, performance, and operating records current each week.',
    id: 'beauty_manager',
    permissions: permissions({ appointments: 'admin', dashboard: 'view', operations: 'edit', performance: 'edit', roster: 'edit' }),
    ...
    restrictions: ['No user-access administration by default.', 'No payroll access by default.', 'No system/settings access by default.'],
    roleValue: 'manager',
    title: 'Beauty Manager',
  },
  {
    description: 'Runs RTB Lounge daily barbershop operations. Financial and system access stay off unless the owner explicitly adds them.',
    expectations: 'Keep RTB Lounge Booksy imports, staff records, performance, booth rent, and operations current.',
    id: 'barbershop_manager',
    permissions: permissions({ appointments: 'edit', booth_rent: 'edit', dashboard: 'view', operations: 'edit', performance: 'edit', roster: 'edit' }),
  ...
  {
    description: 'Helps prepare payroll without access to user management or business settings.',
  ...
  {
    description: 'Maintains SOPs, tasks, action items, and operating records without financial or system access.',
    expectations: 'Keep tasks, SOPs, and operating notes organized so management can act quickly.',
    id: 'operations_assistant',
    permissions: permissions({ dashboard: 'view', operations: 'edit', performance: 'view', roster: 'view' }),
    ...
    restrictions: ['No payroll access.', 'No user access changes.', 'No settings/integration access.', 'No booth rent changes unless customized.'],
    roleValue: 'staff',
  ...
  {
    description: 'Read-only access to selected operational reports. Financial and system areas are off unless the owner explicitly adds them.',
    ...
    restrictions: ['Cannot add, update, delete, finalize, invite, or change settings.', 'No payroll or booth-rent access by default.'],
    roleValue: 'staff',
    title: 'View Only',
  },
];
