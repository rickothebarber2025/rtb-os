...
const OWNER_NAV_PRESENTATION = {
  access: { group: 'Administration', label: 'Access' },
  'action-center': { group: 'Command', label: 'Action Center' },
  'ada-control': { group: 'Administration', label: 'Ada Control' },
  'ai-consultant': { group: 'Operations', label: 'AI Consultant' },
  'customer-intelligence': { group: 'Appointments', label: 'Client Signals' },
  dashboard: { group: 'Command', label: 'Command Center' },
  finance: { group: 'Team & Pay', label: 'Financial Buddy' },
  integrations: { group: 'Administration', label: 'Connections' },
  'marketing-calendar': { group: 'Operations', label: 'Marketing Calendar' },
  'my-role': { group: 'Administration', label: 'My Role' },
  operations: { group: 'Operations', label: 'Daily Operations' },
  payroll: { group: 'Team & Pay', label: 'Payroll' },
  performance: { group: 'Team & Pay', label: 'Performance' },
  staff: { group: 'Team & Pay', label: 'Staff' },
  'staff-hub': { group: 'Messages', label: 'Staff Messages' },
  system: { group: 'Administration', label: 'System Tools' },
